...
while True:
    ...
    connectionSocket, addr = serversocket.accept() #Fill in start -are you accepting connections?  #Fill in start -are you accepting connections?
    ...
    try:
      ...
      f = open(filename[1:],"helloworld.html","r", "utf-8") #fill in start #fill in end)
      #fill in end
